<?php
 ...
 if (have_comments()) : ?>
  <section id="comments">
    <h3 class="comment-title"><?php printf('Comentarios (%1$s)', get_comments_number()); ?></h3>
...
<?php if (comments_open()) : ?>
  <section id="respond">
    <h3 class="comment-title"><?php comment_form_title('Publica un comentario', __('Leave a Reply to %s', 'roots')); ?></h3>
