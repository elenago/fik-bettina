...
function roots_widgets_init() {
  ...
  register_sidebar(array(
    ...
    'id'            => 'sidebar-footer',
    'before_widget' => '<section class="widget %1$s %2$s col-sm-5 col-sm-offset-2">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
  ));
  ...
  register_sidebar(array(
    ...
    'before_widget' => '<section class="widget %1$s %2$s col-sm-5 legal">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
  ));
  ...
  register_sidebar(array(
    'name'          => __('Share product menu', 'roots'),
    'id'            => 'sidebar-shareproductmenu',
    'before_widget' => '<section class="widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
